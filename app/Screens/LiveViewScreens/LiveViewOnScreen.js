...
function LiveViewOnScreen(props)
{
    ...
    const raspberryPiIP = 'http://192.168.10.34:8080/?action=stream';
  ...
  const handleWebViewError = () => {
    setStreamError(true);
      ...
      const bodyStyle = streamError ? styles.errorBody : styles.normalBody;
    ...
    >
      ...
      />
          ...
          // Render the WebView when there is no error
