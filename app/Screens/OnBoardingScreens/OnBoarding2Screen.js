...
import QrCodeImage from '../../assets/Images/QrCodeImage';

function OnBoarding2Screen(props)
{
    ...
    return (
        ...
        <SafeAreaView style={styles.OnBoardingScreen1Container}>
            <View style={styles.primaryTextContainer}>
                <Text>
                    <Text style={styles.OnBoardingPrimaryText}>Getting started is </Text>
                    <Text style={styles.OnBoardingPrimaryHighlitedText}>easy </Text>
                    <Text style={styles.OnBoardingPrimaryText}>!</Text>
                    </Text>
            </View>
            ...
            <View style={styles.descriptionTextContainer}>
                <Text style={styles.OnBoardingDescriptionText}>Just scan the QR code to connect with me.</Text>
            </View>
